...
OutputBaseFilename=setup-vmx-viewer_11231_t
Compression=lzma
...
[Files]
Source: "f:\Drives\OneDrive\Work\VMX\Projects\Delphi\VmxViewer\Bin\Win64\*"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs
;Source: "D:\Work\Projects\Delphi\VmxViewer\Bin\Win64\VMXViewer.exe"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs
;Source: "D:\Work\Projects\Delphi\VmxViewer\Bin\Win64\EncodeString.exe"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs     
;Source: "D:\Work\Projects\Delphi\VmxViewer\Bin\Win64\VMXViewer.ini"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs
...
begin
  ...
  BrowseForFolder('Выберите папку для установки', UserDataDir, True);
